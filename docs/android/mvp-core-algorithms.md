...
选择机型预设会自动切换到对应测光模式。Olympus 35 SP 的面积值由接受角按
42mm 镜头和 24×36mm 画幅换算，分别约为 `19.9%` 与 `1.8%`，取整为
`20%` 与 `2%`。用户手动修改区域面积或权重后，机型预设状态恢复为自定义。
...
```text
1/2000s、1/1000s、1/500s、1/250s、1/125s
1/60s、1/30s、1/15s、1/8s、1/4s、1/2s
1s、2s、4s、8s
```

光圈使用摄影常见的 1/3 档显示值；快门只使用以上经典整档，不生成中间档位。
